...
const RegisterPage = () => {
  ...
  const handleSubmit = async (e) => {
      ...
      if(password!==confirmpassword){
        setError("Both password don't match");
        return;
      }
      try {
          setError("");
        ...
        <div className="min-h-screen py-32 px-4">
            ...
            <div className="w-full max-w-md bg-white rounded-xl shadow-2xl overflow-hidden border">
                <div className="px-6 py-8">
                    ...
                    <div className="font-medium mb-4 mt-5 py-2 ">Already have a account? <span className="text-blue-500 hover:text-blue-700 cursor-pointer" onClick={()=>navigate("/login")}>Login</span></div>
